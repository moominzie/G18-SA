    ...
    "paths": {
        ...
        "/partorders": {
            ...
            "post": {
                ...
                "operationId": "create-partorder",
                "parameters": [
                    {
                        "description": "Partorder entity",
                        "name": "partorder",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/controllers.Partorder"
                        }
                    }
                ],
                "responses": {
        ...
        "/partorders/{id}": {
            "delete": {
                ...
                "operationId": "delete-partorder",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Partorder ID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
    ...
    "definitions": {
        ...
        "ent.EmployeeEdges": {
            ...
            "properties": {
                ...
                "employeepart": {
                    "description": "Employeepart holds the value of the employeepart edge.",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/ent.Partorder"
                    }
        ...
        "ent.PartEdges": {
            ...
            "properties": {
                "partInformations": {
                    "description": "PartInformations holds the value of the part_informations edge.",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/ent.Partorder"
                    }
        ...
        "ent.Partorder": {
            ...
            "properties": {
                "edges": {
                    ...
                    "type": "object",
                    "$ref": "#/definitions/ent.PartorderEdges"
                },
                "id": {
                    "description": "ID of the ent.",
                    "type": "integer"
        ...
        "ent.PartorderEdges": {
            ...
            "properties": {
                ...
                "part": {
                    "description": "Part holds the value of the part edge.",
                    "type": "object",
                    "$ref": "#/definitions/ent.Part"
                },
                "repairinvoice": {

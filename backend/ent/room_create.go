...
func (rc *RoomCreate) SetBuildingID(id int) *RoomCreate {
	rc.mutation.SetBuildingID(id)
	return rc
}

// SetNillableBuildingID sets the building edge to Building by id if the given value is not nil.
func (rc *RoomCreate) SetNillableBuildingID(id *int) *RoomCreate {
	if id != nil {
		rc = rc.SetBuildingID(*id)
	}
	return rc
}

// SetBuilding sets the building edge to Building.
func (rc *RoomCreate) SetBuilding(b *Building) *RoomCreate {
	return rc.SetBuildingID(b.ID)
}
...
func (rc *RoomCreate) createSpec() (*Room, *sqlgraph.CreateSpec) {
	...
	if nodes := rc.mutation.BuildingIDs(); len(nodes) > 0 {

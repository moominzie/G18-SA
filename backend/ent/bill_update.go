...
func (bu *BillUpdate) SetNillableRepairinvoiceID(id *int) *BillUpdate {
	if id != nil {
		bu = bu.SetRepairinvoiceID(*id)
	}
	return bu
}
...
// SetNillableRepairinvoiceID sets the Repairinvoice edge to RepairInvoice by id if the given value is not nil.
func (buo *BillUpdateOne) SetNillableRepairinvoiceID(id *int) *BillUpdateOne {
	if id != nil {
		buo = buo.SetRepairinvoiceID(*id)
	}
	return buo
}
